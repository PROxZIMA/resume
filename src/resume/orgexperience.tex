...
%---------------------------------------------------------
  \cventry
    {Core Team Member Google Developer Student Club \& Microsoft Student Club} % Job title
    ...
    {Sept 2020 - Sept 2022} % Date(s)
    {
      \begin{cvitems} % Description(s) of tasks/responsibilities
        ...
        \item {Build a University \exthref{https://github.com/PROxZIMA/TimetableScheduler}{Timetable Scheduler} model with a colleague, that works using a Genetic algorithm.}
        \item {Build a \exthref{https://github.com/PROxZIMA/certificate-app/}{Certificate App} for easier certificate generation and distribution which helped the college's Sports department to handle competitions and events-related certificates.}
